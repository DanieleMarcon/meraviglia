...
- Follow-up confirmed: additional state-level orchestration paths remain to be hardened for `useAppState` service catalog mutations and `setPiano`-driven dual-proposal re-sanitization under persistence assertions.
